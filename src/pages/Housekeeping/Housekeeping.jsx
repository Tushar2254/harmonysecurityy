...
const housekeepingServices = [
  { title: 'Housekeeping Services for Shopping Malls', description: 'Maintain clean floors, hygienic washrooms and welcoming public areas with a trained team prepared for high visitor footfall.', image: '/Housekeeping/comm.jpg' },
  ...
  { title: 'Housekeeping Services for Parking Areas', description: 'Routine sweeping, litter removal and scheduled deep cleaning for orderly and presentable parking facilities.', image: '/Housekeeping/parking.jpg' },
  ...
  { title: 'Housekeeping Services for Hospitals', description: 'Hygiene-focused support for high-traffic and sensitive areas, delivered through disciplined sanitation procedures.', image: '/Housekeeping/hospital.webp' },
  ...
  { title: 'Housekeeping Services for Factories', description: 'Specialist cleaning support for industrial units to help maintain safe, hygienic and efficient working areas.', image: '/Housekeeping/factory.jpg' },
  ...
  { title: 'Office Boy & Pantry Boy Services', description: 'Trained support personnel for everyday office assistance, professional pantry service and workplace hospitality.', image: '/Housekeeping/pantryboy.jpg' },
]
    ...
    <>
      ...
      <section className="services-grid-section housekeeping-grid-section">
        ...
        <div className="services-grid-header" data-aos="fade-up">
          ...
          <div className="services-trust-row"><span><i className="fas fa-user-check" /> Trained personnel</span><span><i className="fas fa-gears" /> Modern methods</span><span><i className="fas fa-sliders-h" /> Tailored plans</span></div>
        </div>
      ...
      <section className="services-cta-band housekeeping-cta-band">
        <div><span className="services-svc-tag">Need help?</span><h2>Let us build the right HOUSEKEEPING plan for you.</h2><p>Tell us about your facility and our team will recommend a practical, customer-focused housekeeping plan.</p></div>
      ...
      <section className="services-intro housekeeping-intro">
        <div className="services-intro-inner">
          <div className="services-intro-img" data-aos="fade-right"><img src="/Housekeeping/bg.png" alt="Harmony housekeeping personnel at work" loading="lazy" /></div>
