          ...
          <Link to="/" className="nav-logo">
            <span className="nav-logo-mark">
              <span className="nav-logo-flipper">
                <img className="nav-logo-depth nav-logo-depth-one" src="/logo-removebg-preview.png" alt="" />
                <img className="nav-logo-depth nav-logo-depth-two" src="/logo-removebg-preview.png" alt="" />
                <img className="nav-logo-face nav-logo-face-front" src="/logo-removebg-preview.png" alt="Harmony Group Security Services logo" />
                <img className="nav-logo-face nav-logo-face-back" src="/logo-removebg-preview.png" alt="" />
              </span>
